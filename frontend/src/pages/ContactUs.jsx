      ...
      >
        <div className="textContact">
          <p className="pContactUs">
            If you have any inquiries, feedback, or need assistance with vintage
            exchanges, don&apos;t hesitate to reach out to us via email at{" "}
            <span className="spanInfoTroco">info@troco.pro.</span>
          </p>
          <p className="pContactUs">
            Our dedicated team is eager to assist you and ensure a seamless and
            enjoyable experience with our platform.
          </p>
        </div>
