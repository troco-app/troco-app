      ...
      <nav className="pageCategories">
        ...
        <section className="categories" ref={categoriesRef}>
          ...
          >
            ...
            <a onClick={() => handleCategoryClick("Retro Computers")}>
              Computers
            </a>
          </div>
          <div
          ...
          <div
            className="category-container"
            onClick={() => handleCategoryClick("Vintage Audio Equipment")}
          >
          ...
          <div
            className="category-container"
            onClick={() => handleCategoryClick("Vintage Mobile Phones")}
          >
          ...
          <div
            className="category-container"
            onClick={() => handleCategoryClick("Retro Gaming Accessories")}
          >
          ...
          <div
            className="category-container"
            onClick={() => handleCategoryClick("Vintage Watches & Clocks")}
          >
          ...
          <div
            className="category-container"
            onClick={() => handleCategoryClick("Retro Office Equipment")}
          >
