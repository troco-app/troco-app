...
| [Login:](https://youtu.be/SfTg9VGu4ug) Resgitro y login del nuevo usuario                                                                                                       | [![Login](https://i.postimg.cc/jSvGVdFd/2023-08-13-20-48-16.png)](https://youtu.be/SfTg9VGu4ug)                               |
...
| 📬 Ejemplos de email:                                                                               |                                                                       |
| --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| REGISTRO: Como damos la bienvendia a los nuevos Trolocolos y le enviamos el código de confirmación. | ![Registro](https://i.postimg.cc/9DC3TgzV/Email-Troco-Sign-up.png)    |
