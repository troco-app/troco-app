...
export function ItemCardPocket({ product, onDeleteItem }) {
    ...
    const handleDeleteClick = () => {
        RemoveItem(token, product.id)
            .then(() => {
                console.log(
                    `Successfully deleted product with ID: ${product.id}`
                );
                onDeleteItem(product.id);
            })
            .catch((error) => {
                console.error(
                    `Error deleting product with ID: ${product.id}`,
                    error
                );
            });
    };
                ...
                <div className="itemsContainer">
                    <article className="item-pocket">
                        ...
                        >
                            <a
                                onClick={() =>
                                    handleTitleClick(product.user_id)
                                }
                        ...
                        <div className="textItem">
                            ...
                            <a
                                onClick={() =>
                                    handleStoreDetailClick(product.user_id)
                                }
                                style={{ cursor: "pointer" }}
                            >
